...
/** 
 * This class contains information about the current state of the  {@link AtmosphereFramework}. You can also register a  {@link ShutdownHook}.
 * @author Sebastien Dionne : sebastien.dionne@gmail.com
 * @author Jeanfrancois Arcand
 */
public class AtmosphereConfig {
  public static Logger logger=LoggerFactory.getLogger(AtmosphereConfig.class);
  public List<AtmosphereHandlerConfig> atmosphereHandlerConfig=new ArrayList<AtmosphereHandlerConfig>();
  public boolean supportSession;
  public boolean sessionTimeoutRemovalAllowed;
  public boolean throwExceptionOnCloned;
  public boolean useServletContextParameters;
  public AtmosphereFramework framework;
  public Map<String,Object> properties=new HashMap<String,Object>();
  public List<ShutdownHook> shutdownHooks=new ArrayList<ShutdownHook>();
  public List<StartupHook> startUpHook=new ArrayList<StartupHook>();
 ...
 */
  ...
  /** 
 * A shutdown hook that will be called when the  {@link AtmosphereFramework#destroy} method gets invoked. AnApplication can register one of more hooks.
 */
public static interface ShutdownHook {
    void shutdown();
  }
  /** 
 * A Startup hook that will be called when the  {@link AtmosphereFramework#init} method complete. AnApplication can register one of more hooks.
 */
